...
var app = (function () {
    ...
    const file$2 = "src/routes/LoginPage.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "AREA logo");
    			if (!src_url_equal(img.src, img_src_value = "./Logo_AREA.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "logo svelte-1ek3xvb");
    			add_location(img, file$2, 18, 4, 331);
    			attr_dev(input0, "class", "inputText svelte-1ek3xvb");
    			attr_dev(input0, "placeholder", "Email");
    			add_location(input0, file$2, 20, 6, 427);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "inputText svelte-1ek3xvb");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file$2, 21, 6, 500);
    			attr_dev(div0, "class", "inputContainer svelte-1ek3xvb");
    			add_location(div0, file$2, 19, 4, 392);
    			add_location(span, file$2, 26, 2, 772);
    			attr_dev(button0, "class", "forgotPwdButton svelte-1ek3xvb");
    			add_location(button0, file$2, 25, 3, 716);
    			attr_dev(div1, "class", "forgotPwd svelte-1ek3xvb");
    			add_location(div1, file$2, 23, 4, 604);
    			attr_dev(button1, "class", "buttonLogin svelte-1ek3xvb");
    			add_location(button1, file$2, 29, 4, 829);
    			attr_dev(main, "class", "main svelte-1ek3xvb");
    			add_location(main, file$2, 17, 2, 307);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*forgotPwd*/ ctx[3], false, false, false, false),
    					listen_dev(button1, "click", /*login*/ ctx[2], false, false, false, false)
    				];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	return [email, password, login, forgotPwd, input0_input_handler, input1_input_handler];
    }
    ...
    /* src/routes/HomePage.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/routes/HomePage.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "main svelte-7704ei");
    			add_location(main, file$1, 1, 2, 3);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/routes/ForgotPassword.svelte generated by Svelte v3.59.2 */

    const file = "src/routes/ForgotPassword.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "main svelte-13t6e4q");
    ...
    function create_default_slot(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "/", component: LoginPage },
    			$$inline: true
    		});
